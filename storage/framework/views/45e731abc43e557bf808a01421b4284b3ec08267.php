...
<head>
	<title><?php echo e($maintainance->subject_en); ?></title>
	<meta charset="UTF-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"/>
	<meta content="<?php echo e($maintainance->subject_en); ?>" name="description">
	...
	<body class="bg-404">
		<section class="pd-5vw">
			...
			<div class="text-height-1-5 text-grey text-size-18 dpd-20">
				We're busy on upgrading the system. 
				We apologize for the inconvenience. 
			</div>
			<div class="text-height-1-5 text-grey text-size-18 dpd-20">
				To contact us in the meantime please email <br>
				<h2><a href="mailto:info@isidelbeachpark.com">info@isidelbeachpark.com</a></h2>
				or call us <h2><a href="tel:+599-7172926">+599-7172926</a></h2>
			</div>
		</section>
		...
		<section class="bottom-copy">
			<div class="dpd-20">
				<a href="/">
				    <img src="<?php echo e(asset('assets/img/isidel.png')); ?>" style="width: 100px;">
				</a>
			</div>
			<div>© 2024 Isidel Beach Park - All rights reserved</div><br><br>
		</section>

	</body>
</html>

<input type="hidden" id="testid" value="<?php echo e($maintainance->id); ?>">

<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
<script>
    $(document).ready(function(){
        var id = $('#testid').val();
        var url = window.location.origin + "/" + `maintainance-break` + "/" + id;
...
<?php /**PATH /home/wwwsmddeveloper/public_html/ibp/resources/views/maintainance/break.blade.php ENDPATH**/ ?>