...
<?php if(Route::is(['user-bookings']) || Route::is(['user-complete']) || Route::is(['user-ongoing']) || Route::is(['user-cancelled']) ): ?>
    <?php if(!empty($allbookings)): ?>    
        <?php $__currentLoopData = $allbookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bookings): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="modal custom-modal fade request-modal" id="upcoming-court<?php echo e($bookings->booking_id); ?>" role="dialog">
                <div class="modal-dialog modal-dialog-centered modal-md">
                    <div class="modal-content">
                        <div class="modal-header">
                            <div class="form-header modal-header-title">
                                <h4 class="mb-0"><?php echo e(__('string.booking_details')); ?>  <?php echo e($bookings->booking_id); ?>
        							...
        							<?php else: ?>
        							    <?php echo e(__('string.pending')); ?>

        							<?php endif; ?>
        							&nbsp;&nbsp;<span ><?php echo e(__('string.completion_otp')); ?>&nbsp;&nbsp;</span><?php echo e($bookings->completion_otp); ?><span></span>
        						</h4>
                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="card dashboard-card court-information">
                                        <div class="card-header">
                                            <h4><?php echo e(__('string.item_information')); ?></h4>
                                        </div>
                                                ...
                                                <li>
                                                    <div class="appointment-item">
                                                        <div class="appointment-img">
                                                            <img src="<?php echo e(url('/public/storage/'.$bookings->service->thumbnail)); ?>" alt="Booking">
                                                        </div>
                                                        <div class="appointment-content">
                                                            <h6><?php echo e($bookings->service->title); ?></h6>
                                                            <p class="color-green"><?php echo e($bookings->service->category->title); ?></p>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <h6><?php echo e(__('string.booked_on')); ?></h6>
                                                    <p><?php echo e(date('D, d M Y',strtotime($bookings->created_at))); ?></p>
                                                </li>
                                                <li>
                                                    <h6><?php echo e(__('string.price_per_guest')); ?></h6>
                                                    <p><?php echo e($settings->currency); ?><?php echo e(number_format($bookings->service_amount,2)); ?>/<?php echo e(__('string.hrs')); ?></p>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="card dashboard-card court-information">
                                        <div class="card-header">
                                            <h4><?php echo e(__('string.appointment_information')); ?></h4>
                                        </div>
                                        <div class="appointment-info appoin-border">
                                            <ul class="appointmentset">
                                                <li>
                                                    <h6> <?php echo e(__('string.scheduled_date_time')); ?></h6>
                                                    <p><?php echo e(date('D, d M Y',strtotime($bookings->date))); ?></p>
                                                    <p><?php echo e(date('h:i A', strtotime($bookings->time))); ?> </p>
                                                </li>
                                                <li>
                                                    <h6><?php echo e(__('string.total_no_hours')); ?></h6>
                                                    <p> 
                                                        <?php if($bookings['booking_hours']==16): ?>
                                                            <?php echo e(__('string.whole_day')); ?></li>
                                                        <?php else: ?>
                                                            <?php echo e($bookings['booking_hours']); ?>

                                                        <?php endif; ?>
                                                    </p>
                                                </li>
                                                <li>
                                                    <h6><?php echo e(__('string.no_of_guests')); ?></h6>
                                                    <p><?php echo e($bookings->quantity); ?></p>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="card dashboard-card court-information">
                                        <div class="card-header">
                                            <h4><?php echo e(__('string.payment_details')); ?></h4>
                                        </div>
                                        <div class="appointment-info appoin-border ">
                                            <ul class="appointmentsetview">
                                                <li>
                                                    <h6><?php echo e(__('string.total_amount_paid')); ?></h6>
                                                    <p class="color-green"><?php echo e($settings->currency); ?><?php echo e($bookings->payable_amount); ?></p>
                                                </li>
                                                <li>
                                                    <h6><?php echo e(__('string.paid_on')); ?></h6>
                                                    <p><?php echo e(date('D, d M Y',strtotime($bookings->created_at))); ?></p>
                                                </li>
                                                <li>
                                                    <h6><?php echo e(__('string.transaction_id')); ?></h6>
                                                    <?php if($bookings->transaction): ?>
                                                      <p><?php echo e($bookings->transaction->transaction_id); ?></p>
                                                    <?php endif; ?>
                                                    <?php if($bookings->card_transaction): ?>
                                                      <p><?php echo e($bookings->card_transaction->transaction_id); ?></p>
                                                    <?php endif; ?>
                                                </li>
                                                <li>
                                                    <h6><?php echo e(__('string.payment_type')); ?></h6>
                                                    <?php if($bookings->transaction): ?>
                                                        <p>IBP Account</p>
                                                    <?php endif; ?>
                                                    <?php if($bookings->card_transaction): ?>
                                    ...
                                    <?php if($bookings->status==2): ?>
                                        <div class="card dashboard-card court-information">
                                            <div class="card-header">
                                                <h4><?php echo e(__('string.review_details')); ?></h4>
                                            </div>
                                            <?php 
                                                    ...
                                                    <div class="user-review-content">
                                                        <div class="table-rating">
                                                            <div class="rating-point">
                                                                ...
                                                                <?php endfor; ?> 
                                                                <?php for($x = 1; $x <=5-$review->rating; $x++): ?>
                                                        ...
                                                        <h5>Sent on <?php echo e(date('d ,M Y',strtotime($review->created_at))); ?></h5>
                                                    </div>
                                                </div>
                        ...
                        <div class="modal-footer">
                            <div class="table-accept-btn">
                                <a href="javascript:;" data-bs-dismiss="modal" class="btn cancel-table-btn"><?php echo e(__('string.close')); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal custom-modal fade request-modal" id="upcoming-coach" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="form-header modal-header-title">
                        <h4 class="mb-0"><?php echo e(__('string.court_information')); ?><span class="badge bg-info ms-2">Upcoming</span></h4>
                    </div>
                    <a class="close" data-bs-dismiss="modal" aria-label="Close">
                        <span class="align-center" aria-hidden="true"><i class="feather-x"></i></span>
                    </a>
                        ...
                        <div class="col-lg-12">
                                ...
                                <div class="appointment-info">
                                    <ul class="appointmentset">
                                        <li>
                                            <div class="appointment-item">
                                                <div class="appointment-img">
                                                    <img src="<?php echo e(URL::asset('/assets/img/featured/featured-06.jpg')); ?>"
                                                        alt="Venue">
                                                </div>
                                                <div class="appointment-content">
                            ...
                            <div class="card dashboard-card court-information">
                                ...
                                <div class="booking-days">
                                    <ul>
                                        <li class="active">
                                            <img src="<?php echo e(URL::asset('/assets/img/icons/reset.svg')); ?>" class="me-2"
                                                alt="Icon">
                            ...
                            <div class="card dashboard-card court-information">
                                <div class="profile-set">
                                    <div class="profile-set-image">
                                        <img src="<?php echo e(URL::asset('/assets/img/featured/featured-05.jpg')); ?>" alt="Venue">
                                    </div>
                                    <div class="profile-set-content">
                                        ...
                                        <div class="rating-city">
                                            ...
                                            <div class="profile-set-img">
                                                <img src="<?php echo e(URL::asset('/assets/img/flag/usa.png')); ?>"
                                                    alt="User">
                                        ...
                                        <ul>
                                            <li>
                                                <img src="<?php echo e(URL::asset('/assets/img/icons/rank.svg')); ?>"
                                                    alt="Icon">
                                                <h6>Rank : Expert</h6>
                                            </li>
                                            <li>
                                                <img src="<?php echo e(URL::asset('/assets/img/icons/process.svg')); ?>"
                                                    alt="Icon">
                                                <h6>Sessions Completed : 25</h6>
                                            </li>
                                            <li>
                                                <img src="<?php echo e(URL::asset('/assets/img/icons/calendar-alt.svg')); ?>"
                                                    alt="Icon">
                                    ...
                                    <div class="price-set-price">
                                        <h6>Start’s From</h6>
                                        <h5>$250<span>/<?php echo e(__('string.hrs')); ?></span></h5>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="accordion">
                                                ...
                                                <h4 class="accordion-header">
                                                    <button class="accordion-button" type="button">
                                                        <span class="icon-bg"><img
                                                                src="<?php echo e(URL::asset('/assets/img/icons/short-bio.svg')); ?>"
                                            ...
                                            <div class="accordion-item mb-4">
                                                <h4 class="accordion-header">
                                                    <button class="accordion-button" type="button">
                                                        <span class="icon-bg"><img
                                                                src="<?php echo e(URL::asset('/assets/img/icons/lesson-with-me.svg')); ?>"
                                            ...
                                            <div class="accordion-item mb-4">
                                                <h4 class="accordion-header">
                                                    <button class="accordion-button" type="button"
                                                        ...
                                                        <span class="icon-bg"><img
                                                                src="<?php echo e(URL::asset('/assets/img/icons/coaching.svg')); ?>"
                                            ...
                                            <div class="accordion-item mb-4">
                                                <h4 class="accordion-header">
                                                    <button class="accordion-button" type="button"
                                                        ...
                                                        aria-expanded="false">
                                                        <span class="icon-bg"><img
                                                                src="<?php echo e(URL::asset('/assets/img/icons/gallery.svg')); ?>"
                                                        ...
                                                        <div class="owl-carousel gallery-slider owl-theme">
                                                            <div>
                                                                <img class="img-fluid" alt="Gallery"
                                                                    src="<?php echo e(URL::asset('/assets/img/gallery/gallery4/gallery-15.jpg')); ?>">
                                                            </div>
                                                            <div>
                                                                <img class="img-fluid" alt="Gallery"
                                                                    src="<?php echo e(URL::asset('/assets/img/gallery/gallery4/gallery-16.jpg')); ?>">
                                                            </div>
                                                            <div>
                                                                <img class="img-fluid" alt="Gallery"
                                                                    src="<?php echo e(URL::asset('/assets/img/gallery/gallery4/gallery-17.jpg')); ?>">
                                                            </div>
                                                            <div>
                                                                <img class="img-fluid" alt="Gallery"
                                                                    src="<?php echo e(URL::asset('/assets/img/gallery/gallery4/gallery-16.jpg')); ?>">
                                            ...
                                            <div class="accordion-item" id="location">
                                                <h4 class="accordion-header" id="panelsStayOpen-location">
                                                    <button class="accordion-button" type="button"
                                                        ...
                                                        <span class="icon-bg"><img
                                                                src="<?php echo e(URL::asset('/assets/img/icons/location.svg')); ?>"
                                    ...
                                    <div class="tab-pane fade" id="reviews" role="tabpanel"
                                        ...
                                        <div class="review-box review-box-user d-flex">
                                            <div class="review-profile">
                                                <img src="<?php echo e(URL::asset('/assets/img/profiles/avatar-01.jpg')); ?>"
                                            ...
                                            <div class="review-info">
                                                ...
                                                <ul class="review-gallery">
                                                    <li>
                                                        <a href="<?php echo e(URL::asset('/assets/img/gallery/gallery-01.jpg')); ?>"
                                                            data-fancybox="gallery">
                                                            <img class="img-fluid" alt="Image"
                                                                src="<?php echo e(URL::asset('/assets/img/gallery/gallery-01.jpg')); ?>">
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo e(URL::asset('/assets/img/gallery/gallery-02.jpg')); ?>"
                                                            data-fancybox="gallery">
                                                            <img class="img-fluid" alt="Image"
                                                                src="<?php echo e(URL::asset('/assets/img/gallery/gallery-02.jpg')); ?>">
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo e(URL::asset('/assets/img/gallery/gallery-03.jpg')); ?>"
                                                            data-fancybox="gallery">
                                                            <img class="img-fluid" alt="Image"
                                                                src="<?php echo e(URL::asset('/assets/img/gallery/gallery-03.jpg')); ?>">
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo e(URL::asset('/assets/img/gallery/gallery-04.jpg')); ?>"
                                                            data-fancybox="gallery">
                                                            <img class="img-fluid" alt="Image"
                                                                src="<?php echo e(URL::asset('/assets/img/gallery/gallery-04.jpg')); ?>">
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo e(URL::asset('/assets/img/gallery/gallery-05.jpg')); ?>"
                                                            data-fancybox="gallery">
                                                            <img class="img-fluid" alt="Image"
                                                                src="<?php echo e(URL::asset('/assets/img/gallery/gallery-05.jpg')); ?>">
                                                        </a>
                                                    </li>
                                                </ul>
                                        ...
                                        <div class="review-box review-box-user d-flex">
                                            <div class="review-profile">
                                                <img src="<?php echo e(URL::asset('/assets/img/profiles/avatar-02.jpg')); ?>"
                                                ...
                                                <li>
                                                    <div class="preview-tabcontent">
                                                        <div class="preview-tabimg">
                                                            <img src="<?php echo e(URL::asset('/assets/img/services/service-01.jpg')); ?>"
                                                                alt="Service">
                                                        </div>
                                        ...
                                        <div class="preview-tab">
                                            <ul>
                                                <li>
                                                    <div class="preview-tabcontent">
                                                        <div class="preview-tabimg">
                                                            <img src="<?php echo e(URL::asset('/assets/img/services/service-02.jpg')); ?>"
                                                                alt="Service">
                                                        </div>
                                                        <div class="preview-tabname">
                                                            <h4>Marsh Academy</h4>
                                ...
                                <div class="row d-flex align-items-center justify-content-center">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-8">
                                        <div class="d-sm-flex justify-content-start align-items-center">
                                            <a href="javascript:void(0);"><img class="corner-radius-10"
                                                    src="<?php echo e(URL::asset('/assets/img/master-academy.png')); ?>"
                                                    alt="Academy"></a>
                                            <div class="info">
                                                ...
                                                <div class="profile-set-content w-100 p-0">
                                                    <ul class="bg-transparent p-0">
                                                        <li>
                                                            <img src="<?php echo e(URL::asset('/assets/img/icons/location.svg')); ?>"
                                                                alt="Icon">
                                                            <h6> 70 Bright St New York, USA</h6>
                                                        </li>
                                                        <li>
                                                            <img src="<?php echo e(URL::asset('/assets/img/icons/call.svg')); ?>"
                                                                alt="Icon">
                                                            <h6>+3 80992 31212</h6>
                                                        </li>
                                                        <li>
                                                            <img src="<?php echo e(URL::asset('/assets/img/icons/mail.svg')); ?>"
                                                                alt="Icon">
                                                    ...
                                                    <ul class="bg-transparent p-0">
                                                        <li>
                                                            <div class="coach-profile-set-img">
                                                                <img src="<?php echo e(URL::asset('/assets/img/icons/indoor.svg')); ?>"
                                                                    alt="Icon">
                                                            </div>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-4">
                                        <ul class="d-sm-flex align-items-center justify-content-evenly">
                                            <li>
                                                <h3 class="d-inline-block">$150</h3><span>/<?php echo e(__('string.hrs')); ?></span>
                                                <p>up to 1 guests</p>
                                            </li>
                                            <li>
                                            ...
                                            <li class="text-center">
                                                <h3 class="d-inline-block">$5</h3><span>/<?php echo e(__('string.hrs')); ?></span>
                            ...
                            <div class="profile-tab">
                                ...
                                <div class="tab-content">
                                        ...
                                        <div class="accordion">
                                            <div class="accordion-item mb-4">
                                                <h4 class="accordion-header">
                                                    <button class="accordion-button" type="button">
                                                        <span class="icon-bg"><img
                                                                src="<?php echo e(URL::asset('/assets/img/icons/Black.svg')); ?>"
                                            ...
                                            <div class="accordion-item mb-4" id="coaching">
                                                <h4 class="accordion-header" id="panelsStayOpen-coaching">
                                                    <button class="accordion-button" type="button"
                                                        ...
                                                        aria-controls="panelsStayOpen-collapseThree">
                                                        <span class="icon-bg"><img
                                                                src="<?php echo e(URL::asset('/assets/img/icons/includes1.svg')); ?>"
                                                ...
                                                <div class="accordion-collapse ">
                                                    <div class="accordion-body">
                                                        <div class="owl-carousel gallery-slider owl-theme">
                                                            <div>
                                                                <img class="img-fluid" alt="Image"
                                                                    src="<?php echo e(URL::asset('/assets/img/gallery/gallery4/gallery-18.jpg')); ?>">
                                                            </div>
                                                            <div>
                                                                <img class="img-fluid" alt="Image"
                                                                    src="<?php echo e(URL::asset('/assets/img/gallery/gallery4/gallery-19.jpg')); ?>">
                                                            </div>
                                                            <div>
                                                                <img class="img-fluid" alt="Image"
                                                                    src="<?php echo e(URL::asset('/assets/img/gallery/gallery4/gallery-20.jpg')); ?>">
                                                            </div>
                                                            <div>
                                                                <img class="img-fluid" alt="Image"
                                                                    src="<?php echo e(URL::asset('/assets/img/gallery/gallery4/gallery-20.jpg')); ?>">
                                    ...
                                    <div class="tab-pane fade" id="reviews1" role="tabpanel">
                                        <div class="review-box review-box-user d-flex">
                                            <div class="review-profile">
                                                <img src="<?php echo e(URL::asset('/assets/img/profiles/avatar-03.jpg')); ?>"
                                                    class="img-fluid" alt="User">
                                            </div>
                                            <div class="review-info">
                                                <h6 class="mb-2 tittle">Amanda Booked on 06/04/2023</h6>
                                            ...
                                            <div class="preview-tab">
                                                <ul>
                                                    <li>
                                                        <div class="preview-tabcontent">
                                                            <div class="preview-tabimg">
                                                                <img src="<?php echo e(URL::asset('/assets/img/featured/featured-05.jpg')); ?>"
                                                                    alt="Venue">
                                                            </div>
                                                            <div class="preview-tabname">
    ...
    <?php if(!empty($allbookings)): ?>    
        <?php $__currentLoopData = $allbookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bookings): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="modal custom-modal fade payment-modal" id="add-review<?php echo e($bookings->booking_id); ?>" role="dialog">
                <div class="modal-dialog modal-dialog-centered modal-md">
                    <div class="modal-content">
                        <div class="modal-header">
                            <div class="form-header modal-header-title">
                        ...
                        <div class="modal-body">
                            <form  name="addRating" action="<?php echo e(route('add-rating')); ?>" id="addRating" method="post">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="booking_id" value="<?php echo e($bookings->booking_id); ?>" class="form-control" id="reviewer-name">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-space review">
                                            <label class="form-label">Rating <span>*</span></label>
                                                <div class="star-rating">
                                                      <input type="radio" id="5-<?php echo e($bookings->booking_id); ?>" name="rating" value="5" />
                                                      <label for="5-<?php echo e($bookings->booking_id); ?>" class="star">&#9733;</label>
                                                      <input type="radio" id="4-<?php echo e($bookings->booking_id); ?>" name="rating" value="4" />
                                                      <label for="4-<?php echo e($bookings->booking_id); ?>" class="star">&#9733;</label>
                                                      <input type="radio" id="3-<?php echo e($bookings->booking_id); ?>" name="rating" value="3" />
                                                      <label for="3-<?php echo e($bookings->booking_id); ?>" class="star">&#9733;</label>
                                                      <input type="radio" id="2-<?php echo e($bookings->booking_id); ?>" name="rating" value="2" />
                                                      <label for="2-<?php echo e($bookings->booking_id); ?>" class="star">&#9733;</label>
    ...
    <?php if(!empty($allbookings)): ?>    
        <?php $__currentLoopData = $allbookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bookings): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="modal custom-modal fade request-modal" id="cancel-court<?php echo e($bookings->booking_id); ?>" role="dialog">
                 <div class="modal-dialog modal-dialog-centered modal-md">
                    <div class="modal-content">
                        <div class="modal-header">
                            <div class="form-header modal-header-title">
                                <h4 class="mb-0">Booking Details  <?php echo e($bookings->booking_id); ?>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-lg-12">
                                        ...
                                        <div class="appointment-info">
                                            <ul class="appointmentset">
                                                <li>
                                                    <div class="appointment-item">
                                                        <div class="appointment-img">
                                                            <img src="<?php echo e(url('/public/storage/'.$bookings->service->thumbnail)); ?>"
                                                                alt="Booking">
                                                        </div>
                                                        <div class="appointment-content">
                                                            <h6><?php echo e($bookings->service->title); ?></h6>
                                    ...
                                    <div class="card dashboard-card court-information">
                                        <div class="card-header">
                                            <h4><?php echo e(__('string.cancellation_charges_refund')); ?></h4>
                                        </div>
                                        <div class="appointment-info appoin-border ">
                                            <ul class="appointmentsetview">
                                                <?php
                                                ...
                                                ?>
                                                <li>
                                                    <h6><?php echo e(__('string.cancellation_charges')); ?></h6>
                                                    <p class="color-green"><?php echo e($settings->currency); ?><?php echo e(number_format($charge,2)); ?></p>
                                                </li>
                                                <li>
                                                    <h6><?php echo e(__('string.refund')); ?></h6>
                                                    <p><?php echo e($settings->currency); ?><?php echo e(number_format($refund,2)); ?></p>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <div class="modal-footer">
                            <div class="table-accept-btn">
                                ...
                                <a href="javascript:;" class="btn btn-primary" id="cancelBooking"  data-bookingid="<?php echo e($bookings->booking_id); ?>"  >Confirm</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <?php if(!empty($allbookings)): ?>    
        <?php $__currentLoopData = $allbookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bookings): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="modal custom-modal fade request-modal" id="reschedule-booking<?php echo e($bookings->booking_id); ?>" role="dialog">
                <div class="modal-dialog modal-dialog-centered modal-md">
                    <div class="modal-content">
                        <div class="modal-header">
                            <div class="form-header modal-header-title">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="card dashboard-card court-information">
                                        <div class="card-header">
                                            <h4><?php echo e(__('string.reschedule')); ?></h4>
                                        </div>
                                        <div class="appointment-info appoin-border ">
                                            <ul class="appointmentsetview">
                                                <li>
                                                     <div class="mb-3">
                                                        ...
                                                        <div class="form-icon">
                                                            <input type="text" class="form-control datetimepicker" data-maxQauntity="<?php echo e($bookings->quantity); ?>"  data-seviceType="<?php echo e($bookings->service->service_type); ?>"  data-rescheduleslotslist="<?php echo e($bookings->booking_id); ?>"  data-reschedulbookinghours="<?php echo e($bookings->booking_hours); ?>" placeholder="Select Date" id="date">
                                                        </div>
                                                    </div>
                                                </li>
                                                <div class="mb-3" style="width: -webkit-fill-available;">
                                                    ...
                                                    <div class="token-slot mt-2" id="<?php echo e($bookings->booking_id); ?>">No Time Available</div>
                                                </div>
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <div class="modal-footer">
                            <div class="table-accept-btn">
                                ...
                                <a href="javascript:;" class="btn btn-primary rescheduleBooking"   data-bookingid="<?php echo e($bookings->booking_id); ?>"  ><?php echo e(__('string.reschedule')); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php if(Route::is(['event-enquiry-list'])): ?>
    <?php if(!empty($event_inquiries)): ?>    
        <?php $__currentLoopData = $event_inquiries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bookings): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="modal custom-modal fade event-details" id="event-details<?php echo e($bookings->id); ?>" role="dialog">
                <div class="modal-dialog modal-dialog-centered modal-md">
                    <div class="modal-content">
                        <div class="modal-header">
                            <div class="form-header modal-header-title">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="input-space">
                                        <textarea class="form-control" name="comment" id="comment" rows="3" placeholder="Enter Your Review" required><?php echo e($bookings->message); ?></textarea>
                                    </div>
                                </div>
                            </div>
...
<?php if(Route::is(['user-cancelled'])): ?>
                                ...
                                <div class="appointment-info">
                                    <ul class="appointmentset">
                                        <li>
                                            <div class="appointment-item">
                                                <div class="appointment-img">
                                                    <img src="<?php echo e(URL::asset('/assets/img/booking/booking-03.jpg')); ?>"
                                                        alt="Appointment">
                                                </div>
                                                <div class="appointment-content">
                                        ...
                                        <li>
                                            <h6><?php echo e(__('string.Reservá')); ?></h6>
                                            <p>$150 Upto 2 guests</p>
                                        </li>
                                        <li>
                                            <h6><?php echo e(__('string.price_per_guest')); ?></h6><?php echo e(__('string.price_per_guest')); ?>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card dashboard-card court-information">
                                ...
                                <div class="booking-days">
                                    <ul>
                                        <li class="active">
                                            <img src="<?php echo e(URL::asset('assets/img/icons/reset.svg')); ?>"
                                                class="me-2" alt="Icon">
                                            <i class="feather-check-circle me-2"></i>
                                            14 May 2023 - 7:00 PM
                                            <i class="fa fa-check-circle ms-2"></i>
...
<?php if(Route::is(['user-profile-othersetting'])): ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="account-deactive">
                        <img src="<?php echo e(URL::asset('/assets/img/icons/deactive-profile.svg')); ?>" alt="Icon">
    ...
    <div class="modal custom-modal fade deactive-modal" id="success-mail" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="account-deactive">
                        <img src="<?php echo e(URL::asset('/assets/img/icons/email-success.svg')); ?>" alt="Icon">
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="">
                        <input type="number" min="<?php echo e($fee->minimum); ?>" max="<?php echo e($fee->maximum); ?>" name="amount" id="amount" required class="form-control" placeholder="Enter Amount">
                    </div>
                    <span class="text-danger">Amount should be minimum  <?php echo e($settings->currency.number_format($fee->minimum,2)); ?> and maximum <?php echo e($settings->currency.number_format($fee->maximum,2)); ?></span>
                </div>
                <div class="modal-footer">
                    <div class="table-accept-btn">
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <a href="<?php echo e(route('user.create.bank')); ?>" class="mr-2 btn btn-primary text-white"><i class="fa fa-plus"></i> Add New Account</a>
                </div>
                <div class="modal-body">
                    <div class="wallet-wrap wallet-modal">
                        <div class="wallet-amt">
                    ...
                    <?php if(count($banks) == '0'): ?>
                        <div class="input-space text-center mt-3">
                            ...
                            <a href="<?php echo e(route('user.banks')); ?>" class="btn btn-primary">Add Bank</a>
                        </div>
                    <?php else: ?>
                        <div class="">
                            <input type="number" min="<?php echo e($withdraw_fee->minimum); ?>" max="<?php echo e($withdraw_fee->maximum); ?>" name="amount" id="withdraw_amount" required class="form-control" placeholder="Enter Amount" required>
                        </div>
                        <span class="text-danger mb-1">Amount should be minimum  <?php echo e($settings->currency.number_format($withdraw_fee->minimum,2)); ?> and maximum <?php echo e($settings->currency.number_format($withdraw_fee->maximum,2)); ?></span>
                            
                        <?php $__currentLoopData = $banks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="input-space">
                                <select name="bank_id" id="bank_id" class="form-control" required>
                                    <option value="<?php echo e($bank->id); ?>"><?php echo e($bank->bank_name); ?> (<?php echo e($bank->account_holder); ?>)</option>
                                </select>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php if(Route::is(['booking-cancelled'])): ?>
    <div class="modal custom-modal fade request-modal" id="cancel-court" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <div class="modal-header">
                                ...
                                <div class="appointment-info">
                                    <ul class="appointmentset">
                                        <li>
                                            <div class="appointment-item">
                                                <div class="appointment-img">
                                                    <img src="<?php echo e(URL::asset('/assets/img/profiles/avatar-06.jpg')); ?>"
                                                        alt="User">
                                                </div>
                                                <div class="appointment-content">
                                                    <h6>Martina</h6>
...
<?php if(Route::is(['booking-completed'])): ?>
    <div class="modal custom-modal fade request-modal" id="complete-coach" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <div class="modal-header">
...
<?php if(Route::is(['booking-checkout'])): ?>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header text-center d-inline-block">
                    <img src="<?php echo e(URL::asset('/assets/img/icons/booking-confirmed.svg')); ?>" alt="User">
                </div>
                ...
                <div class="modal-footer text-center d-inline-block">
                    <a href="<?php echo e(url('user-dashboard')); ?>" class="btn btn-primary btn-icon"><i
...
<?php if(Route::is(['coach-dashboard'])): ?>
    <div class="modal custom-modal fade request-modal" id="upcoming-coach" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <div class="modal-header">
                                ...
                                <div class="terms-accept">
                                    <div class="d-flex align-items-center form-check">
                                        ...
                                        <label for="terms_accept">I have read and accept <a
                                                href="<?php echo e(url('terms-condition')); ?>">Terms &amp;
                                                Conditions</a></label>
                                    </div>
                                </div>
                            </div>
...
<?php if(Route::is(['coach-payment'])): ?>
    <div class="modal fade" id="bookingconfirmModal" tabindex="-1" aria-labelledby="bookingconfirmModal"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header text-center d-inline-block">
                    <img src="<?php echo e(URL::asset('/assets/img/icons/booking-confirmed.svg')); ?>" alt="Icon">
                </div>
                <div class="modal-body text-center">
                    <h3 class="mb-3">Booking has been Confirmed</h3>
                    <p>Check your email on the booking confirmation</p>
                ...
                <div class="modal-footer text-center d-inline-block">
                    <a href="<?php echo e(url('user-dashboard')); ?>" class="btn btn-primary"><i
                            class="feather-arrow-left-circle me-1"></i>Back to Dashboard</a>
                </div>
            </div>
        </div>
                                ...
                                <div class="appointment-info">
                                    <ul>
                                        <li>
                                            <div class="appointment-item">
                                                <div class="appointment-img">
                                                    <img src="<?php echo e(URL::asset('/assets/img/booking/booking-01.jpg')); ?>"
                                                        alt="User">
                                                </div>
                                                <div class="appointment-content">
                                                    <h6>Wing Sports Academy</h6>
                                ...
                                <div class="appointment-info appoin-border ">
                                    <ul>
                                        <li>
                                            <div class="appointment-item">
                                                <div class="appointment-img">
                                                    <img src="<?php echo e(URL::asset('/assets/img/booking/booking-02.jpg')); ?>"
                                                        alt="User">
                                                </div>
                                                <div class="appointment-content">
                                                    <h6>Martina</h6>
...
<?php if(Route::is(['lesson-payment'])): ?>
    <div class="modal fade" id="bookingconfirmModal" tabindex="-1" aria-labelledby="bookingconfirmModal"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
...
<?php if(Route::is(['profile-othersetting'])): ?>
    <div class="modal custom-modal fade deactive-modal" id="deactive" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <div class="modal-header">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="account-deactive">
                        ...
                        <p>Check your email on the confirmation</p>
                        <div class="convenient-btns">
                            <a href="<?php echo e(url('coach-dashboard')); ?>"
                                class="btn btn-primary d-inline-flex align-items-center me-0">
                                <span><i class="feather-arrow-left-circle me-2"></i></span>Back to Dashboard
                            </a>
                        </div>
...
<?php endif; ?>
<?php /**PATH /home/wwwsmddeveloper/public_html/ibp/resources/views/components/modalpopup.blade.php ENDPATH**/ ?>