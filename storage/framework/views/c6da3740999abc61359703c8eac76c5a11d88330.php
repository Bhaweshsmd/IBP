                    ...
                    <div class="form-login-main-box ">
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="form-x-box main-card ">
                                ...
                                <a class="text-center" href="<?php echo e(route('verify-forgot-password')); ?>" >Forgot Password</a>
                            </div>
                        </form>
                    </div>
                </div>
...
<?php /**PATH /home/wwwsmddeveloper/public_html/ibp/resources/views/auth/login.blade.php ENDPATH**/ ?>