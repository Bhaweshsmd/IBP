                    ...
                    <tr>
                        <td class="column" style="padding: 0; text-align: left; vertical-align: top; color: #60666d; font-size: 14px; line-height: 21px; font-family: sans-serif; width: 600px;">
                            <div class="wrapper" style="background-color: #f2f2f2; text-align: center;">
                                <img style="height: auto; width:100px; margin-bottom: 20px; margin-top: 20px;" src="<?php echo e(url('/assets/img/isidel.png')); ?>" alt="" />
                            </div>
                            <div style="margin-left: 20px; margin-right: 20px;">
                                <?=$msg?>
                            </div>
                            <div style="margin-left: 20px; margin-right: 20px;">
                                <p class="size-14" style="margin-top: 0; margin-bottom: 0; font-size: 14px; line-height: 21px;">Regards,<br /><strong><?php echo e(config('app.name')); ?></strong></p>
                            </div>
                            <div>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td align="center" width="30%" style="vertical-align: top;">
                                                                ...
                                                                <img src="<?php echo e(asset('asset/image/tickfb.png')); ?>" style="border: 1px solid #fff; background: #fff; color: #000; padding: 5px; border-radius: 20px; width: 20px;">
                                                                </a>
                                                            </td>
                                                            <td align="center" width="30%" style="vertical-align: top;">
                                                                <a href="https://www.instagram.com/isidelbeachpark" target="_blank">
                                                                <img src="<?php echo e(asset('asset/image/tickin.png')); ?>" style="border: 1px solid #fff; background: #fff; color: #000; padding: 5px; border-radius: 20px; width: 20px;">
                                                                </a>
                                                            </td>
                                                            <td align="center" class="margin" width="30%" style="vertical-align: top;">
                                                                <a href="#" target="_blank">
                                                                <img src="<?php echo e(asset('asset/image/tickli.png')); ?>" style="border: 1px solid #fff; background: #fff; color: #000; padding: 5px; border-radius: 20px; width: 20px;">
                                                                </a>
                                                            </td>
                                                            <td align="center" class="margin" width="30%" style="vertical-align: top;">
                                                                <a href="#" target="_blank"> 
                                                                <img src="<?php echo e(asset('asset/image/ticktx.png')); ?>" style="border: 1px solid #fff; background: #fff; color: #000; padding: 5px; border-radius: 20px; width: 20px;">
                                                                </a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
...
</html><?php /**PATH /home/wwwsmddeveloper/public_html/ibp/resources/views/basicmail.blade.php ENDPATH**/ ?>