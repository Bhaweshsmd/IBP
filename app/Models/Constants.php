...
final class Constants
{
    ...
    const prefixSalonEarningHistory = "ER";
    const prefixServiceNumber = "S";
    const prefixSalonNumber = "IBP";
    const prefixUserWithDrawRequestNumber = "W";
    const prefixSalonWithDrawRequestNumber = "WTH";
    const prefixBookingId = "B";
    const prefixSalonTransactionId = "TRID";
    const prefixUserTransactionId = "T";
