                ...
                <div id="table">
                    <table>
                        ...
                        <tr class="g-amt">
                            ...
                            <td class="tableitem" align="center"></td>
                            <td class="tableitem" align="right"><p>{{ !empty($card->assigned_on) ? Carbon\Carbon::parse($card->assigned_on)->format('d-M-Y') : 'N/A'}}</p></td>
                        </tr>
                        <tr class="g-amt">
                ...
                <div id="table">
                    <table>
                        ...
                        <tr class="total-qty" >
                            ...
                            <td class="tableitem" align="center"></td>
                            <td class="tableitem" align="right"><p>IBP Card</p></td>
                        </tr>
                        <tr class="total-qty" >
                            <td class="tableitem"><p>Price:</p></td>
                            <td class="tableitem" align="center"></td>
                            <td class="tableitem" align="right"><p>{{$settings->currency}}{{ number_format($card->assign_fee, 2, '.', ',') }}</p></td>
                        </tr>
                        <tr class="total-qty" >
                            <td class="tableitem"><p>Qty:</p></td>
                            <td class="tableitem" align="center"></td>
                            <td class="tableitem" align="right"><p>1</p></td>
                        </tr>
                        <tr class="total-qty" >
