                ...
                <div id="table">
                    <table>
                        <tr class="g-amt">
                            ...
                            <td class="tableitem" align="right"><p>{{ $booking->booking_id }}</p></td>
                        </tr>
                        <tr class="g-amt">
                            <td class="tableitem"><p>Date:</p></td>
                            <td class="tableitem" align="center"></td>
                            <td class="tableitem" align="right"><p>{{ !empty($booking->created_at) ? Carbon\Carbon::parse($booking->created_at)->format('d-M-Y') : 'N/A'}}</p></td>
                        </tr>
                        <tr class="g-amt">
            ...
            <div id="table">
                <table>
                    ...
                    <tr class="total-qty" >
                        ...
                        <td class="tableitem" align="center"></td>
                        <td class="tableitem" align="right"><p>{{ $service->title }}</p></td>
                    </tr>
                    <tr class="total-qty" >
                        ...
                        <td class="tableitem" align="right"><p>
                            @if($user->user_type == '1')
                                {{$settings->currency}}{{ $service->foreiner_price }}/hr
                            @else
                                {{$settings->currency}}{{ $service->price }}/hr
                            @endif
                        </p></td>
                    </tr>
                    <tr class="total-qty" >
                        ...
                        <td class="tableitem" align="center"></td>
                        <td class="tableitem" align="right"><p>{{ $booking->quantity }}</p></td>
                    </tr>
                    <tr class="total-qty" >
                        <td class="tableitem"><p>Hours:</p></td>
                        <td class="tableitem" align="center"></td>
                        <td class="tableitem" align="right"><p>{{ $booking->booking_hours }} hrs</p></td>
                    </tr>
                    <tr class="total-qty" >
                        <td class="tableitem"><p>Schedule date:</p></td>
                        <td class="tableitem" align="center"></td>
                        <td class="tableitem" align="right"><p>{{ !empty($booking->date) ? Carbon\Carbon::parse($booking->date)->format('d-M-Y') : 'N/A'}}</p></td>
                    </tr>
                    <tr class="total-qty" >
                        <td class="tableitem"><p>Schedule Time:</p></td>
                        <td class="tableitem" align="center"></td>
                        <td class="tableitem" align="right"><p>{{ date('h:i A', strtotime($booking->time)) }}</p></td>
                    </tr>
                    <tr class="total-qty" >
                    ...
                    <tr class="tax">
                        ...
                        <td class="tableitem" align="center"></td>
                        <td class="tableitem" align="right"><p>{{$tax->value}}% (Included)</p></td>
                    </tr>
                    <tr class="g-amt">
                        <td class="tableitem"><p>Total Amount:</p></td>
                        <td class="tableitem" align="center"></td>
                        <td class="tableitem" align="right"><p>{{$settings->currency}}{{ number_format($booking->payable_amount, 2, '.', ',') }}</p></td>
                    </tr>
                    <tr class="round-off">
                        <td class="tableitem"><p>Payment method:</p></td>
                        <td class="tableitem" align="center"></td>
                        <td class="tableitem" align="right"><p>{{ ucfirst($booking->payment_method) }}</p></td>
                    </tr>
                    <tr>
                        <td style="padding:2px;"></td>
                        <td style="padding:2px;"></td>
