				...
				<div class="col-sm-12">
					<div class="profile-detail-group">
						<div class="card ">
						    ...
						    <form autocomplete="off" class="form-group form-border" action="{{ route('user.store.bank') }}"  method="post">
                                @csrf
								<div class="row">
									...
									<div class="col-lg-6 col-md-6">
										<div class="input-space">
											...
											<input type="text" class="form-control" name="account_holder" id="account_holder" placeholder="Enter Account Holder" required> 
										</div>
									</div>
									<div class="col-lg-6 col-md-6">
										<div class="input-space">
											<label  class="form-label">{{__('string.swiftcode')}}</label>
											<input type="text" class="form-control" name="swift_code" id="swift_code" placeholder="Enter Swift Code" required>
										</div>
									</div>
								</div>
