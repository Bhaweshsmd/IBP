								...
								<div class="col-xl-7 col-lg-7 col-sm-12 col-12">
									<div class="coach-court-list">
										<ul class="nav">
											...
											<li><a  class="active" href="{{url('user-ongoing')}}">Confirmed</a></li>
														...
														<td class="text-end">
															<div class="dropdown dropdown-action table-drop-action">
																...
																<div class="dropdown-menu dropdown-menu-end">
																 @if($bookings->status==1)																	    
																	<a class="dropdown-item" href="javascript:void(0);"  data-bs-toggle="modal" data-bs-target="#cancel-court{{$bookings->booking_id}}"><i class="feather-corner-down-left"></i>Cancel Booking</a>
																	<a class="dropdown-item" href="javascript:void(0);"  data-bs-toggle="modal" data-bs-target="#reschedule-booking{{$bookings->booking_id}}"><i class="feather-edit"></i>Reschedule</a>
