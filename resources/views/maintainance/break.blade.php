...
<head>
	<title>{{ $maintainance->subject_en }}</title>
	<meta charset="UTF-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"/>
	<meta content="{{ $maintainance->subject_en }}" name="description">
	...
	<body class="bg-404">
		...
		<section class="bottom-copy">
			<div class="dpd-20">
				<a href="/">
				    <img src="{{asset('assets/img/isidel.png')}}" style="width: 100px;">
				</a>
			</div>
...
<input type="hidden" id="testid" value="{{ $maintainance->id }}">
