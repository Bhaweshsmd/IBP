                            ...
                            <li class="user py-2" id="{{ $user->id }}">
                                ...
                                <a class="media">
                                    ...
                                    <div class="media-body ml-2">
                                        <div class="user-name"><strong>{{ $user->first_name }} {{ $user->last_name }}</strong></div>
                                        ...
                                        @if($new_messages > 0)<span style="float: right; position: relative; bottom: 80px;"><div class="badge badge-success badge-pill"><span class="message-count">{{$new_messages}}</span></div></span>@endif
                                    </div>
                                </a>
                            </i>
                        @endforeach 
