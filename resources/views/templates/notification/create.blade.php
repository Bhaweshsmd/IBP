...
@section('content')
    <div class="card mt-3">
        <div class="card-header">
            <h4>{{ __('Add New Notification') }}</h4>
            <a  href="{{route('notification.templates')}}" class="ml-auto btn btn-primary text-white"><i class="fa fa-chevron-left"></i> {{ __('Back to Notification Template') }}</a>
        </div>
        <div class="card-body">
