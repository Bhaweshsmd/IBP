...
@section('content')
    <div class="card mt-3">
        <div class="card-header">
            <h4>{{ __('Edit Admin Notification Templates') }}</h4>

            <a  href="{{route('admin.notification.templates')}}" class="ml-auto btn btn-primary text-white"><i class="fa fa-chevron-left"></i> {{ __('Back to Admin Notification Templates') }}</a>
           </div>
        <div class="card-body">
