@extends('include.app')
@section('header')
    <script src="{{ asset('asset/script/langaugeContent.js') }}"></script>
@endsection

@section('content')
    <div class="card mt-3">
        <div class="card-header">
            <h4>{{ __('Language Contents') }}</h4>
            @if(has_permission(session()->get('user_type'), 'add_content'))
                <a data-toggle="modal" data-target="#addCouponModal" href="" class="ml-auto btn btn-primary text-white"><i class="fa fa-plus"></i> {{ __('Add New Language Content') }}</a>
            @endif
        </div>
        <div class="card-body">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form  method="post" enctype="multipart/form-data" id="editLangaugeFormContent"
                        ...
                        @if(has_permission(session()->get('user_type'), 'edit_content'))
