...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            @if(has_permission(session()->get('user_type'), 'edit_services'))
            ...
            <a href="{{route('services')}}" class="ml-2 btn btn-primary text-white"><i class="fa fa-chevron-left"></i> Back To Service List</a>
        </div>
        ...
        <div class="card-body">
                    ...
                    <div class="col-md-12">
                        <ul class="nav nav-pills border-b  ml-0">
                            <li role="presentation" class="nav-item"> 
                                <a class="nav-link pointer badge bg-primary text-white" href="#tabSlots" role="tab" aria-controls="tabSlots" data-toggle="tab">{{ __('View Schedules and Stocks') }}
                                    <span class="badge badge-transparent "></span>
                                </a>
                                <a data-toggle="modal" data-target="#addBannerModal" href="" class="ml-auto nav-link badge bg-primary text-white text-white">{{ __('+ Add Schedule and Stock') }}</a>
                            </li>
                        </ul>
                                    ...
                                    <div class="mt-2  ">
                                        ...
                                        <div class="slot-time-block">
                                            @foreach ($slots['mondaySlots'] as $item)
                                                <!--<span class="ml-2 btn btn-danger deleteSlots mt-2 " data-id={{$item['id'] }}>×</span>-->
                                                <div class="slot-time-inner">
                                                    <i class="fas fa-trash deleteSlots text-danger" data-id={{$item['id'] }}></i>
            ...
            <form action="{{ route('updateService_Admin') }}" method="post" enctype="multipart/form-data" class="" autocomplete="off">
                @csrf
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <div class="input-group">
                             <select class="form-control" name="service_type" value="{{ old('service_type') }}" required>
                                <option value="0" @if($service->service_type==0) selected @endif >{{__('Quantity Wise')}}</option>
                                <option value="1"  @if($service->service_type==1) selected @endif>{{__('Member Wise')}}</option>
                                </select>
                        </div>
                    </div>
                    <div class="form-group col-md-4">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control" name="qauntity" min="1"  value="{{ old('qauntity',$service->qauntity) }}" required>
                        </div>
                    </div>
                ...
                <div class="form-row ">
                    <div class="form-group col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" name="price" step="any" value="{{ old('price',$service->price) }}" required>
                        </div>
                    </div>
                ...
                <div class="form-row ">
                    <div class="tab-content tabs col-sm-12" id="home">     
                        <div role="tabpanel" class="tab-pane active" id="tabEnglish">
                            ...
                            <div class="form-group">
                                <label for="included_items">{{ __('Included Items In English') }}</label>
                        ...
                        <div role="tabpanel" class="tab-pane " id="tabPapiamentu">
                            ...
                            <div class="form-group ">
                                <label for="included_items_in_papiamentu">{{ __('History In Papiamentu') }}</label>
                        ...
                        <div role="tabpanel" class="tab-pane " id="tabDutch">
                            ...
                            <div class="form-group">
                                <label for="included_items_in_dutch">{{ __('Included Items In Dutch') }}</label>
